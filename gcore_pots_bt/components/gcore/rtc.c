 ...
 * gCore RTC Module
 *
 * Provides access to the gCore Real-Time clock with auto correction enabled.
 *
 * With code from Michael Margolis' time.c file.
 *
 * Copyright 2021, 2023 Michael Margolis and Dan Julio
 *
...
{
	return (rtc_set_time_secs(rtc_makeTime(tm)) == true);
}
